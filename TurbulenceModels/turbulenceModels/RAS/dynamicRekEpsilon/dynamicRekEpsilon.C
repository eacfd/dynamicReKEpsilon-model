...
bool dynamicRekEpsilon<BasicTurbulenceModel>::read()
{
    if (Re_.value() < 23000) 
    { 
         Cmu_ = -4.1211e-10*sqr(Re_) + 1.39592e-05*Re_ - 0.01302;
         C1_ = 1.73876e-13*sqr(Re_)*Re_ - 8.82916e-09*sqr(Re_) + 0.000137049*Re_ + 0.80370;
         C2_ = 2.54313e-13*sqr(Re_)*Re_ - 1.15993e-08*sqr(Re_) + 0.000142776*Re_ + 1.64075;
         sigmak_ = -3.52048e-13*sqr(Re_)*Re_ + 1.82422e-08*sqr(Re_) - 0.000282805*Re_ + 1.79916;
         sigmaEps_ = -1.58706e-13*sqr(Re_)*Re_ + 8.86557e-09*sqr(Re_) - 0.000173304*Re_ + 2.8783;
    }
    else
    {
